			...
			<div class="auth-left">
				...
				<div class="auth-roles">
					...
					<div class="role-pill">
						...
						<div><div class="role-pill-name">Administrateur</div><div class="role-pill-cred">admin@entreprise.com · admin123</div></div>
					</div>
					<div class="role-pill">
						<i class="bi bi-person-check"></i>
						<div><div class="role-pill-name">Responsable RH</div><div class="role-pill-cred">mickael@entreprise.com · rh123</div></div>
					</div>
					<div class="role-pill">
						<i class="bi bi-person"></i>
						<div><div class="role-pill-name">Employé</div><div class="role-pill-cred">jean@entreprise.com · password123</div></div>
					</div>
				</div>
			</div>
			...
			<div class="auth-right">
				...
				<form method="post" action="<?= site_url('/login') ?>" autocomplete="off">
					...
					<div class="f-group">
						...
						<input id="email" name="email" type="email" class="f-input" placeholder="vous@techmada.mg" required />
					</div>
					<div class="f-group">
						<label class="f-label" for="password">Mot de passe</label>
						<input id="password" name="password" type="password" class="f-input" placeholder="••••••••" required />
					</div>
